...
type UserPermissions<T extends boolean > = T extends true ? AdminPermissions : BasicPermissions; 
...
function isCar(vehicle: Car | Bike): vehicle is Car  {
  return 'type' in vehicle && (vehicle.type === 'sedan' || vehicle.type === 'truck' || vehicle.type === 'hatchback' || vehicle.type === 'minivan');
}
